 ...
 */
final class Version20200313065911 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE processus_enveloppe_gamme_enveloppe CHANGE gamme_enveloppe_id gamme_enveloppe_id INT DEFAULT NULL, CHANGE processus_enveloppe_id processus_enveloppe_id INT DEFAULT NULL');
