 ...
 */
final class Version20191218083915 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE poste_travail_proto (id INT AUTO_INCREMENT NOT NULL, pdt_id INT DEFAULT NULL, reference VARCHAR(24) NOT NULL, description VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8F5F296FAB0F5606 (pdt_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE regle (id INT AUTO_INCREMENT NOT NULL, question VARCHAR(255) NOT NULL, aide LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, api_token VARCHAR(191) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D6497BA2F5EB (api_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE activite_poste_travail (activite_id INT NOT NULL, poste_travail_id INT NOT NULL, INDEX IDX_E076A7449B0F88B1 (activite_id), INDEX IDX_E076A7449FEBDA9B (poste_travail_id), PRIMARY KEY(activite_id, poste_travail_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE poste_travail (id INT AUTO_INCREMENT NOT NULL, centre_production_id INT DEFAULT NULL, poste_travail_proto_id INT DEFAULT NULL, reference VARCHAR(64) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_E033582B8876423D (centre_production_id), UNIQUE INDEX UNIQ_E033582B9A589A2C (poste_travail_proto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE centre_production ADD CONSTRAINT FK_477EEECDCCF9E01E FOREIGN KEY (departement_id) REFERENCES departement (id) ON DELETE SET NULL');
